...
import fb from '../../logo/facebook-logo-3-1.png'
import google from '../../logo/google-logo.jpg'
...
const Login = () => {
  ...
  const updateUserName = name => {
    ...
    updateProfile(auth.currentUser, {
      ...
      console.log('update name seccesfully');
      getLogedInUser()
    }).catch((error) => {
      console.log(error);
    });
  ...
  return (
    <div className='login'>
      ...
      <h4>or</h4>
      <div onClick={handleFbLogin} className="fb-login">
        <img src={fb} alt="" />
